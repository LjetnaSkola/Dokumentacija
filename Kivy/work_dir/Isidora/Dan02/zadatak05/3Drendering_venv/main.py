...
class Renderer(Widget):
    ...
    def setup_scene(self):
        Color(1, 1, 1, 1)
        PushMatrix()
        # First argument represents the position on X axes (horizontal position) - higher the number, position of the head is translated to the right
        # Second argument represents the position on Y axes (vertical position) - higher the number, higher the position of the head
        # Third argument represents the distance from the screen (smaller the number, smaller the head - it's further away)
        Translate(0, 0, -3)
        # Second argument: if 1, it rotates around X axes
        # Third argument: if 1, it rotates around Y axes
        # Fourth argument: if 1, it rotates around Y axes
